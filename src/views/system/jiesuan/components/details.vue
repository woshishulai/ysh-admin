            ...
            <div class="box">
                ...
                <div class="tables" v-if="list">
                    ...
                    <el-table v-loading="loading" :data="list" v-if="active == '申诉记录'" style="width: 100%">
                        ...
                        <el-table-column prop="content" label="评论内容" align="center" width="180" />
                        <el-table-column prop="goodsName" label="商品服务" align="center" />
                        ...
                        <el-table-column prop="add_time" align="center" width="200" label="支付时间" />
                    </el-table>
